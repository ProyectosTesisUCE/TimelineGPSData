...
directorio_entrada="D:/TesisPrincipal/Marcos/Pruebas/"
...
#tabla_prediccion.loc[tabla_prediccion['Actividad']=="0",'Actividad']="CON_VEHICULO"
#tabla_prediccion.loc[tabla_prediccion['Actividad']=="2",'Actividad']="SIN_VEHICULO"
#tabla_prediccion.loc[tabla_prediccion['Actividad']=="3",'Actividad']="SIN_VEHICULO"
...
plt.show()
#g15=str(tabla_prediccion["Actividad"].value_counts())

#tabla_prediccion.loc[tabla_prediccion['Actividad']=="CON_VEHICULO",'Actividad']=0
#tabla_prediccion.loc[tabla_prediccion['Actividad']=="SIN_VEHICULO",'Actividad']=2
#tabla_prediccion.loc[tabla_prediccion['Actividad']=="QUIETO",'Actividad']=3

###########################Grafico

tabla_tilting.loc[tabla_tilting['Actividad']=="0",'Actividad']="CON_VEHICULO"
tabla_tilting.loc[tabla_tilting['Actividad']=="2",'Actividad']="SIN_VEHICULO"
tabla_tilting.loc[tabla_tilting['Actividad']=="3",'Actividad']="SIN_VEHICULO"
...
plt.gca().yaxis.set_major_formatter(PercentFormatter(1))
plt.show()
g16=str(tabla_tilting["Actividad"].value_counts())

tabla_tilting.loc[tabla_tilting['Actividad']=="CON_VEHICULO",'Actividad']=0
tabla_tilting.loc[tabla_tilting['Actividad']=="SIN_VEHICULO",'Actividad']=2
#tabla_tilting.loc[tabla_tilting['Actividad']=="QUIETO",'Actividad']=3

###################################################################
tabla_entrenamiento["Actividad"]=tabla_entrenamiento["activity1"]
result=tabla_entrenamiento.append([tabla_tilting])
